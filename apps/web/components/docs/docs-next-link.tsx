...
export const DocsNextLink = ({
  ...
  >
    ...
    <ArrowRightIcon className="size-5 shrink-0 text-muted-foreground transition group-hover:translate-x-1 group-hover:text-violet-400" />
  </Link>
);
